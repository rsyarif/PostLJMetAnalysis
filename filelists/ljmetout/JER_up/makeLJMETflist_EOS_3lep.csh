...
set in=/eos/uscms/store/user/lpcljm/LJMet_3lep_122115/JER_up//
if ($1) then
...
set output_area=/uscms_data/d3/rsyarif/Spring2016/TprimeANALYSIS_copy/CMSSW_7_4_15/src/LJMet/Com/filelists/ljmetout/JER_up/
#cd $output_area
set first=1
#foreach d ( `ls -1` )
foreach d ( `els $in` )
