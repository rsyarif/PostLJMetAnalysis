...
set in=/eos/uscms/store/user/lpcljm/LJMet_3lep_122115/nominal/
if ($1) then
...
set output_area=/uscms_data/d3/rsyarif/Spring2016/TprimeANALYSIS_copy/CMSSW_7_4_15/src/LJMet/Com/filelists/ljmetout/nominal/
#cd $output_area
set first=1
#foreach d ( `ls -1` )
foreach d ( `els $in` )
